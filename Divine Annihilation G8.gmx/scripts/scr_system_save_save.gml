...
global.itemCatagorySlot1 = ini_write_real(argument0, "itemCatagorySlot1", spr_menu_inventory_icon_none);
global.itemCatagorySlot2 = ini_write_real(argument0, "itemCatagorySlot2", spr_menu_inventory_icon_none);
global.itemCatagorySlot3 = ini_write_real(argument0, "itemCatagorySlot3", spr_menu_inventory_icon_none);
global.itemCatagorySlot4 = ini_write_real(argument0, "itemCatagorySlot4", spr_menu_inventory_icon_none);
global.itemCatagorySlot5 = ini_write_real(argument0, "itemCatagorySlot5", spr_menu_inventory_icon_none);
...
global.equipmentCatagorySlot1 = ini_write_real(argument0, "equipmentCatagorySlot1", spr_menu_inventory_icon_none);
global.equipmentCatagorySlot2 = ini_write_real(argument0, "equipmentCatagorySlot2", spr_menu_inventory_icon_none);
global.equipmentCatagorySlot3 = ini_write_real(argument0, "equipmentCatagorySlot3", spr_menu_inventory_icon_none);
global.equipmentCatagorySlot4 = ini_write_real(argument0, "equipmentCatagorySlot4", spr_menu_inventory_icon_none);
global.equipmentCatagorySlot5 = ini_write_real(argument0, "equipmentCatagorySlot5", spr_menu_inventory_icon_none);
ini_close();
