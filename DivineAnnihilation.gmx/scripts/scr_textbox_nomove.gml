...
draw_sprite(s_menu_battle_intro, 1, view_xview, (view_yview+352))
...
draw_text_ext(view_xview+padding,((view_yview+view_hview)-max_height)-(padding/2)-35,'------------',sTxt_height,max_width);

// Quit Dialogue/Textbox Event
if txt == "" && global.placeholderTxt == ""{
    global.tboxActive_nomove = false;
    txt = global.txtCache;
    global.txtCache = "";
    cinteract_nomove = 0
}
